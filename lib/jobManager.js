...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processShare = function (jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress,
     port, workerName, pobhhash, blockHex, x11hash, sRecipient, nABNPassed, sPoolAddress, hasabn) {
        ...
        if (!job.registerSubmit(pobhhash, x11hash, nTime, nonce)) {
            console.log('duplicate share pobhh %s x11 %', pobhhash, x11hash);
